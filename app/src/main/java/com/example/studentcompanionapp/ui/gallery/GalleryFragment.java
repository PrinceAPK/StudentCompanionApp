package com.example.studentcompanionapp.ui.gallery;
...
public class GalleryFragment extends Fragment {
    ...
    private void getOtherImage() {
        reference.child("Special Events").addValueEventListener(new ValueEventListener() {
    ...
    private void getConvoImage() {
        reference.child("Misc Events").addValueEventListener(new ValueEventListener() {
